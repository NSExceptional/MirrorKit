...
/** Constructs a new property with the given name and attributes. @discussion Consider using \c propertyWithName:attributes: */
...
/** @return A getter for the property with the given implementation. @discussion Consider using the \c MKPropertyGetter macros. */
- (MKSimpleMethod *)getterWithImplementation:(IMP)implementation;
/** @return A setter for the property with the given implementation. @discussion Consider using the \c MKPropertySetter macros. */
